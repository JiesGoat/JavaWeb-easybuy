...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1>欢迎回到易买网</h1>
			<form id="loginForm" method="get" action="usersServlet" onsubmit="return checkForm(this)">
				<table>
					<tr>
						<td class="field">用户编号：</td>
						<td><input class="text" type="text" name="uid" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
